...
// // Create a new job (assumes authentication for company)
...
//       salary,
//       location,
//       industry, // Add other relevant fields
//       employmentType // Add other relevant fields
//     } = req.body;

//     // Input Validation
//     if (!title || !description || !requirements || !company) {
...
//       industry,
//       employmentType,
//       company: req.user.companyId, // Associate job with the company
//     });
...
//     // 4. Check if Company Exists (Optional)
//     // You might want to check if the company specified in the job data exists
//     // This step can prevent issues if a user provides an invalid company ID

//     // 5. Create New Job Object
//     const newJob = new Job({
//       title,
//       description,
//       requirements,
